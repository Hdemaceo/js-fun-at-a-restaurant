...
// 'We need to get some more [food].'
 ...
 var stockCount;
 if (stockCount < 1){
   console.log("I'm goign to eat some " + food + "!");
 } else {
   console.log("We need to get some " + food + ".");
 }
...
var vegetables = ["carrots", "tomatoes", "asparagus", "zucchini", "cucumber"];
...
// different fruits.
var fruits = ["strawberries", "blueberries", "blackberries", "raspberries", "bananas", "oranges", "apples"];
